...
export const reportKpis: KpiCard[] = [
  {
    id: 'time',
    label: 'Tempo total semana',
    value: '12h 30min',
    delta: '−45 min vs semana passada',
    positive: true,
    icon: 'schedule',
  },
  {
...
export const dailyMinutesByDay = [
  { day: 'Seg', lucas: 110, sofia: 60, theo: 30 },
  { day: 'Ter', lucas: 95, sofia: 85, theo: 25 },
  { day: 'Qua', lucas: 140, sofia: 70, theo: 35 },
  { day: 'Qui', lucas: 120, sofia: 50, theo: 20 },
  { day: 'Sex', lucas: 160, sofia: 90, theo: 40 },
  { day: 'Sáb', lucas: 220, sofia: 180, theo: 55 },
  { day: 'Dom', lucas: 190, sofia: 130, theo: 50 },
];
...
export const topSites: TopSite[] = [
  { id: 't1', domain: 'roblox.com', category: 'Jogos', totalMinutes: 320, topChild: 'Lucas' },
  { id: 't2', domain: 'khanacademy.org', category: 'Educacional', totalMinutes: 215, topChild: 'Sofia' },
  { id: 't3', domain: 'youtubekids.com', category: 'Vídeos', totalMinutes: 165, topChild: 'Théo' },
  { id: 't4', domain: 'duolingo.com', category: 'Educacional', totalMinutes: 95, topChild: 'Sofia' },
  { id: 't5', domain: 'cocojam.com', category: 'Vídeos', totalMinutes: 60, topChild: 'Théo' },
];
